...
public:
	...
	*/
	...
	unsigned long getLastFallingEdge() {
		return lastFallingEdge;
	}
...
protected:
	...
	static volatile unsigned long lastFallingEdge;
...
template<uint8_t Pin> volatile unsigned long ServoInputPin<Pin>::lastFallingEdge = 0;
